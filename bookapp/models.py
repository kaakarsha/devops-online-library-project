"""
Models module for managing books and book allotments.
"""
...
class BookModel(models.Model):
    """
    Model representing a book with title, image, and description.
    """
...
class BookAllotmentModel(models.Model):
    """
    Model representing the allotment of books to users.
    """
